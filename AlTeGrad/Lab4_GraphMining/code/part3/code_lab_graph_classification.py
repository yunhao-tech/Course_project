...
print(f"The accuracy of SVM using kernel matrix generated by the shortest path kernel is {accuracy_score(y_test, y_pred_sp)}.")

# graphlet kernel
clf = SVC(kernel='precomputed') 
clf.fit(K_train_graphlet, y_train)
y_pred_graphlet = clf.predict(K_test_graphlet)
print(f"The accuracy of SVM using kernel matrix generated by the graphlet kernel is {accuracy_score(y_test, y_pred_graphlet)}.")
