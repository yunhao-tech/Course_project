...
def load_cora():
    idx_features_labels = np.genfromtxt("AlTeGrad/Lab5_DeepWalk_GCN/code/data/cora.content", dtype=np.dtype(str))
    ...
    edges_unordered = np.genfromtxt("AlTeGrad/Lab5_DeepWalk_GCN/code/data/cora.cites", dtype=np.int32)
